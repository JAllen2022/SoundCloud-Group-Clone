...
# https://appacademypictures.s3.us-west-2.amazonaws.com/all-your-days.jpeg
    ...
    song3 = Song(user_id=4, title="Marea (we've lost dancing)", artist="Fred again..", genre="Electronic", description="released by Fred Again..", length=4.45, song_url="https://appacademymusic.s3.us-west-2.amazonaws.com/mareawe'velostdancing-fredagain.mp3", song_image_url="https://appacademypictures.s3.us-west-2.amazonaws.com/marea-weve-lost-dancing.png", song_likes=[roysa, jason, demo])
    ...
    song16 = Song(user_id=2, title="A Cerulean State - Perhaps things had finally begun to move", artist="A Cerulean State", genre="Ambient", description="Hope you enjoy! :)", length=4.13, song_url="https://appacademymusic.s3.us-west-2.amazonaws.com/A+Cerulean+State+-+Perhaps+things+had+finally+begun+to+move.mp3", song_image_url="https://appacademypictures.s3.us-west-2.amazonaws.com/perhaps.jpeg", song_likes=[ryan, demo, jason])
